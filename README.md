...
>  
> 📢 **따라서, 중요한 정보는 별도로 검증하고, 민감한 응답에는 추가적인 필터링을 적용하는 것이 필요합니다.**

---

# ✨ 최종 요약

> 초기 Gemma 2B 모델은 느린 속도와 다국어 대응 부족으로 실사용에 제약이 있었습니다.  
> OpenChat 3.5로 전환하고 4bit 양자화, FP16 최적화, GPU 메모리 오프로딩 등을 통해  
> **더 빠르고 안정적이며, 글로벌 시장을 목표로 하는 텍스트 생성 시스템**을 구축할 수 있었습니다.
